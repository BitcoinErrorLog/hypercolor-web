// Historical `hypercolor-shell-v2` worker, exactly as deployed to
// https://hypercolor.app before the v3 fix. Kept so `sw-upgrade.spec.ts`
// can reproduce a returning visitor whose browser is still controlled by v2.
// Do not "fix" this file — its bugs are the thing under test.
