// Historical `hypercolor-shell-v3` worker, recovered from public/sw.js at
// 62bfe3d (before the v4 bump). Kept so `sw-upgrade.spec.ts` can prove a
// returning visitor whose browser is still controlled by v3 upgrades onto
// the current worker and that activate purges the v3 cache. Do not "fix"
// this file — it is the previous version under test.
