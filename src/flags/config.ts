...
/** Max deferred DM tags retained per (owner, peer, sender). */
export const CHAT_TAG_DEFERRED_QUOTA_PER_SENDER = 32;

/** Deferred DM tags older than this are discarded during replay/admission. */
export const CHAT_TAG_DEFERRED_TTL_MS = 48 * 60 * 60 * 1000;
